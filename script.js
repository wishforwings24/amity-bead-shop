...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const productPrice = 8.00; // Store as number for calc
        ...
        12: { name: "Elpheba", category: "classic", desc: "A beautiful handcrafted bead bracelet to add to your collection.", filename: "Elpheba.jpg" },
        ...
        16: { name: "Fluro Crush", category: "classic", desc: "A beautiful handcrafted bead bracelet to add to your collection.", filename: "Fluro Crush.jpg" },
        ...
        18: { name: "Glow in the Dark", category: "classic", desc: "A beautiful handcrafted bead bracelet to add to your collection.", filename: "Glow in the Dark.jpg" },
        ...
        20: { name: "Grape Green", category: "classic", desc: "A burst of summer energy! These translucent green beads capture the essence of vineyard-fresh grapes.", filename: "Grape Green.jpg" },
        21: { name: "Grape Purple", category: "classic", desc: "Rich amethyst-coloured beads that add a royal touch to your jewellery collection.", filename: "Grape Purple.jpg" },
        22: { name: "Green Love", category: "classic", desc: "A beautiful handcrafted bead bracelet to add to your collection.", filename: "Green Love.jpg" },
        23: { name: "Green Lovey-Dovey", category: "classic", desc: "A beautiful handcrafted bead bracelet to add to your collection.", filename: "Green Lovey-Dovey.jpg" },
        ...
        28: { name: "ILY Heart", category: "classic", desc: "A beautiful handcrafted bead bracelet to add to your collection.", filename: "ILY Heart.jpg" },
        ...
        43: { name: "Multi Colour Mix", category: "classic", desc: "A beautiful handcrafted bead bracelet to add to your collection.", filename: "Multi Colour Mix.jpg" },
        44: { name: "Neon Crush", category: "classic", desc: "A beautiful handcrafted bead bracelet to add to your collection.", filename: "Neon Crush.jpg" },
        45: { name: "Neon Party (Choker Necklace)", category: "classic", desc: "A beautiful handcrafted bead bracelet to add to your collection.", filename: "Neon Party (Choker Necklace).jpg" },
        46: { name: "Obsidian Large", category: "classic", desc: "A beautiful handcrafted bead bracelet to add to your collection.", filename: "Obsidian Large.jpg" },
        47: { name: "Orange Bomb", category: "classic", desc: "A beautiful handcrafted bead bracelet to add to your collection.", filename: "Orange Bomb.jpg" },
        48: { name: "Orange Sorbet 1", category: "classic", desc: "A beautiful handcrafted bead bracelet to add to your collection.", filename: "Orange Sorbet 1.jpg" },
        49: { name: "Orange Sorbet 2", category: "classic", desc: "A beautiful handcrafted bead bracelet to add to your collection.", filename: "Orange Sorbet 2.jpg" },
        ...
        63: { name: "Rainbow Mix", category: "classic", desc: "A beautiful handcrafted bead bracelet to add to your collection.", filename: "Rainbow Mix.jpg" },
        ...
        65: { name: "Rockin' Strawberry", category: "classic", desc: "A beautiful handcrafted bead bracelet to add to your collection.", filename: "Rockin' Strawberry.jpg" },
        66: { name: "Royal", category: "classic", desc: "A beautiful handcrafted bead bracelet to add to your collection.", filename: "Royal.jpg" },
        67: { name: "See Through Fish", category: "classic", desc: "A beautiful handcrafted bead bracelet to add to your collection.", filename: "See Through Fish.jpg" },
        ...
        69: { name: "Shiny Blue Mini", category: "classic", desc: "A beautiful handcrafted bead bracelet to add to your collection.", filename: "Shiny Blue Mini.jpg" },
        ...
        71: { name: "Space Galaxy", category: "classic", desc: "A beautiful handcrafted bead bracelet to add to your collection.", filename: "Space Galaxy.jpg" },
        72: { name: "Sweet Cherry Pie", category: "classic", desc: "Deep red 'cherry' beads paired with crust-coloured neutrals. Deliciously charming.", filename: "Sweet Cherry Pie.jpg" },
        73: { name: "Teachers Pet", category: "classic", desc: "A beautiful handcrafted bead bracelet to add to your collection.", filename: "Teachers Pet.jpg" },
        ...
        77: { name: "Violet Crumble", category: "classic", desc: "A beautiful handcrafted bead bracelet to add to your collection.", filename: "Violet Crumble.jpg" },
        ...
        79: { name: "Vitamin C Mini", category: "classic", desc: "A beautiful handcrafted bead bracelet to add to your collection.", filename: "Vitamin C Mini.jpg" },
        80: { name: "Wicked", category: "classic", desc: "A beautiful handcrafted bead bracelet to add to your collection.", filename: "Wicked.jpg" },
        81: { name: "Zesty Pop", category: "classic", desc: "Lime and lemon tones that practically sizzle with citrus energy.", filename: "Zesty Pop.jpg" },
